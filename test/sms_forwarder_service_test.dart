...
void main() {
  group('forwardSms', () {
    ...
    test('sends to multiple destinations and returns one LogEntry per recipient', () async {
      final fake = FakeSmsService();
      final entries = await forwardSms(
        smsService: fake,
        message: makeSmsMessage(address: 'BofA', body: 'Code 1234.'),
      ...
      expect(tos, containsAll(['+12025550123', '+19998887777', '+13335554444']));
    });
    ...
    test('preprocesses body — strips <#> prefix and 11-char hash suffix', () async {
      final fake = FakeSmsService();
      final entries = await forwardSms(
        smsService: fake,
